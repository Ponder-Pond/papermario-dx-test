...
/// Cold Caverns
#include "area_ccv/ccv.h"
MapConfig ccv_maps[] = {
    { MAP(ccv_01) },
    { MAP(ccv_02) },
};

/// Piranha Plant Village
#include "area_ppv/ppv.h"
MapConfig ppv_maps[] = {
    { MAP(ppv_01) },
};
...
AreaConfig gAreas[] = {
    ...
    AREA(ccv, "Cold Caverns"), // ccv [Cold Caverns]
    AREA(ppv, "Piranha Plant Village"), // ppv [Piranha Plant Village]
    {},
};
