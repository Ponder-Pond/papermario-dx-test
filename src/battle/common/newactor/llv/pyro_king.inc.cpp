...
extern EvtScript EVS_Move_MakeClones;
extern EvtScript EVS_Move_SummonBits;
extern EvtScript EVS_Attack_IceBolt;
extern EvtScript EVS_Attack_IcyBreath;
extern EvtScript EVS_Attack_CloneBreath;
extern EvtScript EVS_Attack_SpitBits;
extern EvtScript EVS_Move_Recover;

// Actor Stats
constexpr s32 hp = 45;
constexpr s32 dmgSpitBit = 4;
constexpr s32 dmgIceBolt = 6;
constexpr s32 dmgIceBreath = 8;
constexpr s32 dmgCloneBreath = 8;
...
static Vec3f BitSuctionPaths[3][3];
...
EvtScript EVS_OnHit = {
    ...
    IfEq(LVarA, TRUE)
        Call(GetActorVar, ACTOR_SELF, AVAR_Clone1_ID, LVar9)
        Exec(EVS_RemoveClone)
        Call(GetActorVar, ACTOR_SELF, AVAR_Clone2_ID, LVar9)
        ExecGetTID(EVS_RemoveClone, LVar0)
        Label(1)
    ...
    Switch(LVar0)
        ...
        CaseEq(AVAL_Move_AttackWithBits)
            ...
            IfLe(LVar0, 1)
                ...
                IfFlag(LVar0, STATUS_FLAG_FROZEN)
                    ExecWait(EVS_Attack_IcyBreath)
                Else
                    ExecWait(EVS_Attack_IceBolt)
                EndIf
            Else
                ExecWait(EVS_Attack_SpitBits)
            EndIf
        ...
        CaseEq(AVAL_Move_AttackWithClones)
            ...
            IfLe(LVar0, 1)
                ...
                Call(SetActorVar, ACTOR_SELF, AVAR_NextMove, AVAL_Move_AfterBitsAttack)
            Else
                ExecWait(EVS_Attack_CloneBreath)
...
EvtScript EVS_Attack_IcyBreath = {
    Call(UseIdleAnimation, ACTOR_SELF, FALSE)
    Call(EnableIdleScript, ACTOR_SELF, IDLE_SCRIPT_DISABLE)
    ...
    Call(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_ICE | DAMAGE_TYPE_NO_CONTACT, 0, 0, dmgIceBreath, BS_FLAGS1_TRIGGER_EVENTS)
    Switch(LVar0)
...
EvtScript EVS_Attack_IceBolt = {
    ...
    Wait(2)
    Call(SetGoalToTarget, ACTOR_SELF)
    Call(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_ICE | DAMAGE_TYPE_NO_CONTACT, 0, DMG_STATUS_IGNORE_RES(STATUS_FLAG_FROZEN, 2), dmgIceBolt, BS_FLAGS1_TRIGGER_EVENTS)
    Switch(LVar0)
        CaseOrEq(HIT_RESULT_HIT)
        CaseOrEq(HIT_RESULT_NO_DAMAGE)
            Call(SetGoalToTarget, ACTOR_SELF)
...
EvtScript EVS_Clone_Dummy = {
    Return
    End
};

EvtScript EVS_Init_Clone = {
    Call(BindTakeTurn, ACTOR_SELF, Ref(EVS_Clone_Dummy))
    Call(BindIdle, ACTOR_SELF, Ref(EVS_Clone_Dummy))
    Call(BindHandleEvent, ACTOR_SELF, Ref(EVS_Clone_Dummy))
    Return
    End
};

ActorBlueprint Clone = {
    ...
    .initScript = &EVS_Init_Clone,
    .statusTable = CloneStatusTable,
    .escapeChance = 0,
    .airLiftChance = 0,
    .hurricaneChance = 0,
    .spookChance = 0,
...
EvtScript EVS_Move_MakeClones = {
    ...
    IfFlag(LVar0, AVAL_Flag_HadLowHP)
        ...
        Call(GetActorVar, ACTOR_SELF, AVAR_Clone2_ID, LVar0)
        Call(SetActorFlagBits, LVar0, ACTOR_FLAG_FLYING, TRUE)
        ExecGetTID(EVS_UpdateHovering, LVar0)
...
Formation CubeBitFormation = {
    ACTOR_BY_POS(A(crystal_bit_cube), CloneSummonPos, 0),
};

Formation SphereBitFormation = {
    ACTOR_BY_POS(A(crystal_bit_sphere), CloneSummonPos, 0),
};

Formation PrismBitFormation = {
    ACTOR_BY_POS(A(crystal_bit_prism), CloneSummonPos, 0),
};

s32 CubeBitSummonData[16] = {};

s32 SphereBitSummonData[16] = {};

s32 PrismBitSummonData[16] = {};

EvtScript EVS_SummonBit = {
    UseArray(LVar4)
    ...
    Call(GetActorPos, ACTOR_SELF, LVarA, LVarB, LVarC)
    Call(CalculateAngle, ArrayVar(6), LVarA, LVarC, LVar1, LVar3)
...
EvtScript EVS_Move_SummonBits = {
    ...
    Wait(20)
    Call(SummonEnemy, Ref(CubeBitFormation), FALSE)
    Call(SetActorVar, ACTOR_SELF, AVAR_King_CubeBitID, LVar0)
    Call(SummonEnemy, Ref(SphereBitFormation), FALSE)
    Call(SetActorVar, ACTOR_SELF, AVAR_King_SphereBitID, LVar0)
    Call(SummonEnemy, Ref(PrismBitFormation), FALSE)
...
EvtScript EVS_Attack_CloneBreath = {
    Call(GetActorVar, ACTOR_SELF, AVAR_Clone1_ID, LVarA)
    Call(GetActorVar, ACTOR_SELF, AVAR_Clone2_ID, LVarB)
    Call(UseIdleAnimation, ACTOR_SELF, FALSE)
    ...
    Wait(2)
    Call(SetGoalToTarget, ACTOR_SELF)
    Call(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_ICE | DAMAGE_TYPE_NO_CONTACT, 0, 0, dmgCloneBreath, BS_FLAGS1_TRIGGER_EVENTS)
    Switch(LVar0)
        CaseOrEq(HIT_RESULT_HIT)
        CaseOrEq(HIT_RESULT_NO_DAMAGE)
            Call(UseBattleCamPreset, BTL_CAM_DEFAULT)
...
EvtScript EVS_InhaleBit = {
    ...
    Else
        ...
        Add(LVar4, 8)
    EndIf
    Call(MakeSuctionPath, LVarB, LVar0, LVar1, LVar2, LVar3, LVar4, LVar5)
...
EvtScript EVS_SpitSingleBit = {
    ...
    Call(FlyToGoal, LVarA, 0, 0, EASING_LINEAR)
    Wait(2)
    Call(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_ICE | DAMAGE_TYPE_NO_CONTACT, 0, 0, dmgSpitBit, 0)
...
EvtScript EVS_Attack_SpitBits = {
    ...
    Call(ActorExists, LVar0, LVar1)
    IfEq(LVar1, TRUE)
        Set(LVar1, &BitSuctionPaths[0])
        ExecGetTID(EVS_InhaleBit, LVarA)
    EndIf
    Call(GetActorVar, ACTOR_SELF, AVAR_King_SphereBitID, LVar0)
    Call(ActorExists, LVar0, LVar1)
    IfEq(LVar1, TRUE)
        Set(LVar1, &BitSuctionPaths[1])
        ExecGetTID(EVS_InhaleBit, LVarA)
    EndIf
    Call(GetActorVar, ACTOR_SELF, AVAR_King_PrismBitID, LVar0)
    Call(ActorExists, LVar0, LVar1)
    IfEq(LVar1, TRUE)
        Set(LVar1, &BitSuctionPaths[2])
        ExecGetTID(EVS_InhaleBit, LVarA)
    EndIf
    Label(0)
        IsThreadRunning(LVarA, LVar0)
    ...
    Switch(LVar0)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            IfEq(LVar1, TRUE)
                Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_CrystalKing_Anim1C)
                ExecGetTID(EVS_RemoveBit, LVarA)
                Wait(4)
                Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_CrystalKing_Anim15)
                Wait(6)
            EndIf
    ...
    IfEq(LVar1, TRUE)
        Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_CrystalKing_Anim1C)
        ExecGetTID(EVS_SpitSingleBit, LVarA)
        Wait(4)
        Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_CrystalKing_Anim15)
        Wait(6)
    EndIf
...
ActorBlueprint PyroKing = {
    .flags = 0,
    .maxHP = pyro_king::hp,
    .type = ACTOR_TYPE_CRYSTAL_KING,
    .level = ACTOR_LEVEL_CRYSTAL_KING,
    .partCount = ARRAY_COUNT(pyro_king::ActorParts),
    .partsData = pyro_king::ActorParts,
    .initScript = &pyro_king::EVS_Init,
    .statusTable = pyro_king::StatusTable,
    .escapeChance = 0,
    .airLiftChance = 0,
    .hurricaneChance = 0,
    .spookChance = 0,
