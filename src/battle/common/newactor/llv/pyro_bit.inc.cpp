...
ActorPartBlueprint SphereParts[] = {
    {
        .flags = ACTOR_PART_FLAG_NO_TARGET,
        .index = PRT_MAIN,
        .posOffset = { 0, 0, 0 },
...
ActorBlueprint PyroCube = {
    .flags = ACTOR_FLAG_FLYING | ACTOR_FLAG_NO_ATTACK,
    .maxHP = pyro_bit::hp,
    .type = ACTOR_TYPE_CRYSTAL_BIT,
    .level = ACTOR_LEVEL_CRYSTAL_BIT,
    .partCount = ARRAY_COUNT(pyro_bit::CubeParts),
    .partsData = pyro_bit::CubeParts,
    .initScript = &pyro_bit::EVS_Init,
    .statusTable = pyro_bit::StatusTable,
    .escapeChance = 0,
    .airLiftChance = 0,
    .hurricaneChance = 0,
    .spookChance = 0,
...
ActorBlueprint PyroSphere = {
    .flags = ACTOR_FLAG_FLYING | ACTOR_FLAG_NO_ATTACK,
    .maxHP = pyro_bit::hp,
    .type = ACTOR_TYPE_CRYSTAL_BIT,
    .level = ACTOR_LEVEL_CRYSTAL_BIT,
    .partCount = ARRAY_COUNT(pyro_bit::SphereParts),
    .partsData = pyro_bit::SphereParts,
    .initScript = &pyro_bit::EVS_Init,
    .statusTable = pyro_bit::StatusTable,
    .escapeChance = 0,
    .airLiftChance = 0,
...
ActorBlueprint PyroPrism = {
    .flags = ACTOR_FLAG_FLYING | ACTOR_FLAG_NO_ATTACK,
    .maxHP = pyro_bit::hp,
    .type = ACTOR_TYPE_CRYSTAL_BIT,
    .level = ACTOR_LEVEL_CRYSTAL_BIT,
    .partCount = ARRAY_COUNT(pyro_bit::PrismParts),
    .partsData = pyro_bit::PrismParts,
    .initScript = &pyro_bit::EVS_Init,
    .statusTable = pyro_bit::StatusTable,
    .escapeChance = 0,
    .airLiftChance = 0,
